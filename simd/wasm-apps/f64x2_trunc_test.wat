(module
  ...
  (func $test_basic_truncation (export "test_basic_truncation")
  ...
  ;; Tests large magnitude values, precision limits, and boundary conditions
  ...
  ;; Tests ±infinity, NaN values, and exact integer inputs
